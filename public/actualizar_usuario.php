...
<head>
    ...
    <title>Chuzo || Actualizar Usuario</title>
</head>
...
<body class="body">
    ...
    <div class="container">
        <form method="post">
            ...
            <div>
                <input class="input" type="text" class="input-with-logo" name="documento" required maxlength="15" value="<?php echo $user['usu_documento']; ?>">
            </div>
            <div class="title-form">
                <h3 class="title-h4">Nombre</h3>
            </div>
            <div>
                <input class="input" type="text" class="input-with-logo" name="nombre" required maxlength="30" value="<?php echo $user['usu_nombre']; ?>">
            </div>
            <div class="title-form">
                <h3 class="title-h4">Apellido</h3>
            </div>
            <div>
                <input class="input" type="text" class="input-with-logo" name="apellido" required maxlength="30" value="<?php echo $user['usu_apellido']; ?>">
            </div>
            <div class="title-form">
                <h3 class="title-h4">Correo</h3>
            </div>
            <div>
                <input class="input" type="email" class="input-with-logo" multiple name="email" required maxlength="30" value="<?php echo $user['usu_email']; ?>">
            </div>
            <div class="title-form">
            ...
            <select name="select" class="input" required>
                ...
                <option value="<?php //lo que se envia
                    if(!$user['usu_admin'] == 1){echo "1"; }else {echo "0";}?>"> 
                    <?php //Lo que ve el usuario
                    if(!$user['usu_admin'] == 1) {echo "Si";} else {echo "No";}
                    ?>
                </option>
                </select>
            </div>
    ...
    if(isset($_POST['enviar'])){
        ...
        if(actualizar_usuario($id, $doc, $nom, $ape, $eml, $adm) == true){
            ...
            window.location.replace("actualizar_usuario.php");</script>';
        }
    }
    ?>
